...
//手筋・格言
  ...
  {"text": "一歩千金", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "終盤のたった一枚の歩が勝敗を分けるほど大きな価値を持つこと。"},
  {"text": "二枚替えなら歩ともせよ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "相手の銀や金と歩を二枚交換できるなら積極的に応じるべきであること。"},
  {"text": "三歩持ったら継ぎ歩とたれ歩", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "歩を三枚持てば継ぎ歩や垂れ歩といった強力な攻め筋が生まれること。"},
  {"text": "５三のと金に負けなし", "level": "中級", "senpou": "common", "category": "keisei", "meaning": "敵陣深く（５三など）に作ったと金は非常に強力で形勢を大きくリードすること。"},
  {"text": "と金のおそはや", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "と金は遅いようだが作ってしまえば非常に強力で勝ちに直結すること。"},
  {"text": "まむしのと金", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "まむしのようにしつこく敵陣を荒らすと金は相手にとって非常に脅威であること。"},
  {"text": "焦点の歩に好手あり", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "複数の利きが集中する地点に歩を打つことで相手の駒を効率よく捌けること。"},
  {"text": "打ち歩詰めに詰みの余地あり", "level": "上級", "senpou": "common", "category": "kakugen", "meaning": "打ち歩詰めは禁じ手だがそれを利用して別の攻め筋を探す工夫が必要であること。"},
  ...
  {"text": "中段玉は寄せにくし", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "玉が中央に出ると逃げ道が多く寄せが非常に難しくなること。"},
  {"text": "玉の腹から銀を打て", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "玉の側面（腹）から銀を打つと相手の逃げ道を制限できること。"},
  {"text": "端玉には端歩", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "端へ逃げた玉には端歩を突くのが最も効果的な寄せ筋であること。"},
  {"text": "桂頭の玉寄せにくし", "level": "上級", "senpou": "common", "category": "kakugen", "meaning": "玉が桂馬の頭にいるときは逃げ道が多く寄せにくいこと。"},
  {"text": "飛車先の歩交換三つの得あり", "level": "初級", "senpou": "ibisha", "category": "kakugen", "meaning": "飛車先の歩を交換することで持ち歩・開戦・将来的な突き越しなどの利があること。"},
  {"text": "攻めは飛角銀桂守りは金銀三枚", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "攻める駒と守る駒のバランスを意識した配置の基本であること。"},
  {"text": "駒は中央へ向かえ", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "中央を制する者がゲームを制する。駒は効率よく中央へ活用すること。"},
  {"text": "飛車は十字に使え", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "飛車を縦横の両方向に活用できると攻めの破壊力が増すこと。"},
  {"text": "角筋は受けにくし", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "角の斜めの利きは独特で相手にとって受けが難しいこと。"},
  {"text": "要の金をねらえ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "守りの要である金駒を目標に攻めるのが効率的であること。"},
  {"text": "金はとどめに残せ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "攻め駒を使い切るより最後の詰めに金を残しておくと決めやすいこと。"},
  {"text": "三桂あって詰まぬ事なし", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "桂馬を三枚持てばどんな玉でも詰ませられるほど攻撃力が高いこと。"},
  {"text": "４枚の攻めは切れない", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "連携した４枚の駒による攻めは簡単には防ぎきれないということ。"},
  {"text": "玉飛車接近すべからず", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "玉と飛車を近づけると一撃で両取りをかけられる危険があること。"},
  {"text": "金なし将棋に受け手なし", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "守りの要である金がないと受けが全く成立しなくなること。"},
  {"text": "攻めは銀、受けは金", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "銀は機動力があり攻めに、金は安定しており守りに向いていること。"},
  {"text": "馬の守りは金銀三枚", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "馬を作られても金銀三枚で堅く守れば突破されにくいこと。"},
  {"text": "大駒は近づけて受けよ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "遠くから狙われると脅威だが近くに受け駒を打てば威力を殺せること。"},
  {"text": "金底の歩岩より固し", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "金の下に歩を打つ守り方は非常に堅く突破されにくいこと。"},
  {"text": "金は引く手に好手あり", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "金は引くことで攻めをいなし新たな守りを形成できること。"},
  {"text": "歩越銀には歩で受けよ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "相手の銀が歩を越えてきたらこちらも歩で突っかけてその銀を圧迫すべきであること。"},
  {"text": "５五の位は天王山", "level": "初級", "senpou": "common", "category": "keisei", "meaning": "中央の要所（５五）に駒を配置することは主導権を握る上で非常に重要であること。"},
  {"text": "終盤は駒の損得より速度", "level": "中級", "senpou": "common", "category": "keisei", "meaning": "終盤では駒の枚数より相手玉を詰ますスピードを優先すべきであること。"},
  {"text": "風邪を引いても後手ひくな", "level": "中級", "senpou": "common", "category": "keisei", "meaning": "体調が悪くても攻めの手番（先手）を相手に渡してはいけないという気合の教え。"},
  {"text": "位を取ったら位の確保", "level": "中級", "senpou": "common", "category": "keisei", "meaning": "有利な場所（位）を確保したらそれを維持して活用することが大切であること。"},
  {"text": "長い詰みより短い必死", "level": "上級", "senpou": "common", "category": "keisei", "meaning": "複雑で長い詰みを探すより確実に勝てる「必死」をかける方が実戦的であること。"},
  {"text": "不利なときは戦線拡大", "level": "上級", "senpou": "common", "category": "keisei", "meaning": "不利な局面では局面を複雑化させ相手にミスを誘う戦い方が有効であること。"},
  {"text": "大駒は離して打て", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "大駒を近づけて打つと捕まりやすいため離して使って利きを広げること。"},
  {"text": "序盤は飛車より角", "level": "初級", "senpou": "common", "category": "kakugen", "meaning": "序盤は遠見の利きが働く角を優先的に活用すべきであること。"},
  ...
  {"text": "桂頭の銀", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "桂馬の頭に銀を打つと相手の跳ねを防ぎつつ強力な形になること。"},
  {"text": "桂は控えて打て", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "桂馬は直接的に当てるより一段後ろから打つ方が逃げ道もあり使いやすいこと。"},
  {"text": "香は下段から打て", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "香は下段から打つことで将来的な利きを長く確保できること。"},
  {"text": "香を持ったら歩の裏を狙え", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "香車は歩の裏から打つことで相手の陣形を効率よく貫通できること。"},
  {"text": "寄せは俗手に好手あり", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "芸術的な手より単純で泥臭い「俗手」の方が終盤では有効な場合が多いこと。"},
  {"text": "逃げ道に捨て駒", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "玉の逃げ道に駒を捨てることで強制的に退路を断つテクニック。"},
  {"text": "敵の打ちたい所に打て", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "敵の好手となる地点を先取りする（自分の駒を配置する）防衛術。"},
  {"text": "敵の急所は自分の急所", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "相手が最も嫌がる地点は自分にとっても重要な拠点であること。"},
  {"text": "端に手あり", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "盤面の中央が膠着したときは端に活路を見出すのが定石であること。"},
  {"text": "浮き駒に手あり", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "味方に守られていない（浮いている）駒は標的にされやすいこと。"},
  {"text": "両取り逃げるべからず", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "両取りをかけられてももっと厳しい攻めを返せば怖くないということ。"},
  {"text": "遊び駒を活用せよ", "level": "中級", "senpou": "common", "category": "kakugen", "meaning": "働いていない駒を戦線に加えることが勝率アップの近道であること。"},
